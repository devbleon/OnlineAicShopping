			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="cname">Nombre del dueño de la tarjeta</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Dirección de envío igual que facturación
					</label>';
				$i = 1;
				$total = 0;
				...
				<input type="hidden" name="total_count" value="' . $total_count . '">
					...
					<input type="submit" id="submit" value="Continuar con la comprobación" class="checkout-btn">
				</form>
				</div>
			</div>
			';
		...
		<div class="row">
			<div class="col-md-12">
				<div class="newsletter">
					<p>Suscribirse para recibir mas ofertas de nuestros productos en la empresa <strong>Aic Master Servi Electric</strong></p>
					<form>
						<input class="input" type="email" placeholder="Ingrese su correo electrónico aquí...">
