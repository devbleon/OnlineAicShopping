            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="../index.php" class="signup-image-link">Devuelta a casa</a>


                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Admin Iniciar Sesión</h2>
                        <form class="register-form" id="login-form" action="login.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="admin_username" id="your_name" placeholder="Admin Correo" />
                            </div>
                            <div class="form-group">
