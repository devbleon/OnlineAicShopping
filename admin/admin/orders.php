...
if (isset($_GET['action']) && $_GET['action'] != "" && $_GET['action'] == 'delete') {
  ...
  mysqli_query($con, "delete from orders where order_id='$order_id'") or die("Borrar la consulta es incorrecta...");
}
    ...
    <div class="col-md-14">
      <div class="card ">
        <div class="card-header card-header-primary">
          <h4 class="card-title">Pedidos / Página <?php echo $page; ?> </h4>
        </div>
        <div class="card-body">
