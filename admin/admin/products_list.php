...
if (isset($_GET['action']) && $_GET['action'] != "" && $_GET['action'] == 'delete') {
  ...
  $result = mysqli_query($con, "select product_image from products where product_id='$product_id'")
    or die("La consulta es incorrecta...");
  ...
  /*this is delet query*/
  mysqli_query($con, "delete from products where product_id='$product_id'") or die("La consulta es incorrecta...");
}
          ...
          <div class="table-responsive ps">
            <table class="table tablesorter " id="page1">
              ...
              <tbody>
                ...
                $result = mysqli_query($con, "select product_id,product_image, product_title,product_price from products  where  product_cat=1 or product_cat=2 or product_cat=3 Limit $page1,12") or die("La consulta es incorrecta.....");
                ...
                while (list($product_id, $image, $product_name, $price) = mysqli_fetch_array($result)) {
                  ...
                  if ($_SESSION['role'] != 'e') {
                    echo "
                        <a class=' btn btn-success' href='edit_product.php?product_id=$product_id'>Editar</a>
