        ...
        <div class="row">
                ...
                <div class="card card-chart">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-category">
                            <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span> Aumento en las ventas de hoy.
                        </p>
                    </div>
            ...
            <div class="col-xl-4 col-lg-12">
                <div class="card card-chart">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Suscripciones de Correo</h4>
                        <p class="card-category">Rendimiento de la ultima campaña</p>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
            ...
            <div class="col-xl-4 col-lg-12">
                <div class="card card-chart">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            <i class="material-icons">access_time</i> Campaña enviada hace dos días
                        </div>
                    </div>
                </div>
            </div>
