...
if (isset($_POST['btn_save'])) {
  ...
  if ($picture_type == "image/jpeg" || $picture_type == "image/jpg" || $picture_type == "image/png" || $picture_type == "image/gif") {
    ...
    mysqli_query($con, "UPDATE `products` SET `product_title` = '$product_name', 
        ...
        `product_price`='$price',`product_desc`='$details',`product_image`='$pic_name',`product_keywords`='$tags' WHERE `product_id` = '$product_id'") or die("La Consulta es incorrecta..........");
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="product_type" name="product_type" required class="form-control">
                      <option value="" style="color:black;">Seleccionar Categorias</option>
                      <?php

                      $result1 = mysqli_query($con, "SELECT * FROM `categories` ORDER BY `cat_id` ASC") or die("La consulta es incorrecta.....");
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="brand" name="brand" required class="form-control">
                      <option value="" style="color:black;">Seleccionar el tipo</option>
                      <?php
                      $result2 = mysqli_query($con, "SELECT * FROM `brands`") or die("La consulta es incorrecta.....");
