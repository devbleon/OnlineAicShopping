...
<body style="background-color: #999999;">
	<div id="toast">
		<div id="desc"> Descripción del Inicio de Sesión</div>
	</div>
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form onsubmit="return false" id="login" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Se requiere un correo electrónico por ejemplo: example@gmail.com">
						...
						<input class="input100" type="email" name="email" placeholder="Escriba aquí su correo electrónico...">
			...
			<div class="login100-more" style="background-image: url('img/wallpaper2.png');"></div>
		</div>
	</div>
