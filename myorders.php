...
<section class="section main main-raised">
    <div class="container-fluid ">
        <div class="wrap cf">
            <h1 class="projTitle">Todos tus pedidos</h1>
            <div class="heading cf">
                <h1>Mis Pedidos</h1>
                <h1 style="margin-left:55%">cantidad</h1>
                <a href="store.php" class="continue">Continuar comprando</a>
            </div>
            <div class="cart">
                <ul class="cartWrap">
                    <?php
                            ...
                            <ul class="cartWrap">
                                ...
                                <tr>
                                    <div class="infoWrap"> 
                                        ...
                                        <p class="stockStatus out"> Envío</p>
                                        </div>  
                                ...
                                if ($i == $numRows + 1) {
                                    ...
                                    <div class="subtotal cf">
                                        ...
                                        <li class="totalRow"><span class="label">Subtotal</span><span class="value">&#x20B9; ' . $prev_total . '</span></li>
                                            ...
                                            <li class="totalRow"><span class="label">Envío</span><span class="value">&#x20B9; 0.00</span></li>
