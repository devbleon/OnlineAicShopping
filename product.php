							...
							<div class="col-md-5">
								<div class="product-details">
									...
									<ul class="product-btns">
										<li><a href="#" pid="' . $row['product_id'] . '"  id="wishlist" ><i class="fa fa-heart-o"></i> Agrear a lista de favoritos</a></li>
								...
								<div class="col-md-3 mainn">
									<div id="review-form">
										<form class="review-form" onsubmit="return false" id="review_form" required>
											...
											<button class="primary-btn" name="review_submit">Entregar</button>
										</form>
									</div>
								</div>
								<!-- /Review Form -->
