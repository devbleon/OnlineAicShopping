					...
					<div class="navbar navbar-inverse navbar-fixed-top">
						<div class="container-fluid">
							<div class="navbar-header">
								<a href="#" class="navbar-brand">Almacén AiCMaster</a>
							</div>
							...
							<div class="col-md-8">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<h1>Gracias </h1>
										<hr />
										<p>Hola <?php echo "<b>" . $_SESSION["name"] . "</b>"; ?>,Su proceso de pago esta
											completado con éxito y su ID de transacción es <b><?php echo $trx_id; ?></b><br />
											tu puedes continuar con tus compras <br /></p>
